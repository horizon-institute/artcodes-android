            ...
            public void run()
            {
                ...
                for (MarkerImage markerImage : markerImages)
                {
                    ...
                    if (markerImage != null)
                    {
                        ...
                        {
                            markerImageView = LayoutInflater.from(context).inflate(R.layout.marker_thumbnail, relativeLayout);
                            final ImageView imageView = markerImageView.findViewById(R.id.marker_thumbnail_image);
                            if (imageView == null)
                            {
                                continue;
                            }
