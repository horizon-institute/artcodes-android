...
public class MarkerEmbeddedChecksumDetector extends MarkerDetector
{
	...
	MarkerEmbeddedChecksumDetector(Experience experience, MarkerDetectionHandler handler, boolean embeddedChecksumRequired, boolean relaxed)
	{
	...
	MarkerRegion getChecksumRegionAtNode(int regionIndex, Mat hierarchy)
	{
